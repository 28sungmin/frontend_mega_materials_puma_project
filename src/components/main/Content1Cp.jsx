...
const Content1Cp = () => {
  ...
  return (
    <div className="content1 pt-20">
      <SectionTitleAtm
        className="section-title py-70"
        titleTextProps="New Arrivals"
      />

      <ul className="product-list d-flex flex-wrap">
        {/* 고정형 텍스트 파트 */}
        <li className="list">
          <ImgAtm srcProps={newArrivals} altProps="new arrivals 배경" />
          <div className="context">
            <div className="dark d-flex flex-direction-column justify-content-center align-items-center p-40">
              <h4>Products Launch</h4>
              <p>
                Stay in the know with the latest drops and upcoming launches,
                plus early access to PUMA exclusives. Catch it here first.
              </p>
            </div>
          </div>
        </li>
